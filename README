...
## Future Improvements
- Enhanced visuals (e.g., colored output).
...
## Author
Developed as a simple C programming project to demonstrate dynamic memory allocation, file handling, and basic game mechanics.
